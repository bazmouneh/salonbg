...
class SignUpBloc extends Bloc<SignUpEvent, SignUpState> {
  ...
  ///SixthPage
  TextEditingController bankNameController = TextEditingController(text: "Bank Name");
TextEditingController accountNumberController = TextEditingController(text: "1234567890");
TextEditingController reEnterAccountNumberController = TextEditingController(text: "1234567890");
TextEditingController holderNameController = TextEditingController(text: "First Name Last Name");
TextEditingController swiftCodeController = TextEditingController(text: "SWIFT1234");
